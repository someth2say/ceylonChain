...
//ChainingCallable<Integer,String> stringSizeChain = chain(stringSizeCallable2);
...
//    assertEquals(stringSizeChain.with(helloMessage), stringSizeCallable2(helloMessage), "Invoking a ChainStart should directly invoke the method on the params"); //12
//}
//
...
//
//    assertEquals(printStringSizeEven.with(helloMessage), integerEvenCallable(stringSizeCallable2(helloMessage)), "Chained callables should be equivalent to invonking those callables in the opposing order."); // true
//    assertEquals(printStringSizeEven.with(byeMessage), integerEvenCallable(stringSizeCallable2(byeMessage)), "Chained callables should be equivalent to invonking those callables in the opposing order."); // false
//}
//
