...
shared Result(Second)(First) swap<Result, First, Second>(Result(First)(Second) func) => (First f)(Second s) => func(s)(f);
...
{
    shared default IIterable<{FuncReturn*},Arguments,FuncReturn> map<FuncReturn>(FuncReturn(FuncParam) operation) => IterableChainable<{FuncReturn*},Arguments,Return,FuncReturn>(this, swap(Return.map<FuncReturn>)(operation));
}
