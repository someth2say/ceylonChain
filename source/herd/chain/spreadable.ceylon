...
class Spreadable<NewReturn, Arguments, Return>(IInvocable<Return,Arguments> prevCallable, NewReturn(Return) func)
...
class SpreadingChainable<NewReturn, Arguments, Return>(IInvocable<Return,Arguments> prevCallable, NewReturn(*Return) func) satisfies IChainable<NewReturn,Arguments>
...
class SpreadingSpreadable<NewReturn, Arguments, Return>(IInvocable<Return,Arguments> prevSpreadable, NewReturn(*Return) func) satisfies ISpreadable<NewReturn,Arguments>
        given Return satisfies [Anything*]
        given NewReturn satisfies [Anything*]
{
...
shared ISpreadable<Return,Arguments> chainSpreadable<Return, Arguments>(Return(Arguments) func) given Return satisfies Anything[] => ChainStartSpread(func);

class ChainStartSpread<Return, Arguments>(Return(Arguments) func) extends Invocable<Return,Arguments>(func) satisfies ISpreadable<Return,Arguments>
        given Return satisfies Anything[] {
