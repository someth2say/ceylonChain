...
//    //shared ChainingCallable<NewChainReturn?,ChainArguments> ifSpreadThen<NewChainReturn>(NewChainReturn(ChainReturn) newFunc) => ChainSpread(this, newFunc);
//}
//
//
...
////class ChainSpread<out PrevReturn,out Return,in Arguments>(ChainingCallable<PrevReturn,Arguments> prevChain, Return(PrevReturn) func) satisfies ChainingCallable<Return?,Arguments>
...
//   // shared actual default Return? with(Arguments arguments) => let (PrevReturn prev = prevChain.with(arguments)) func(*prev) ;
//}
